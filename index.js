...
function addFlavor(ray){

    ray.unshift("Rainbow Sherbert");
    return(ray);

}

console.log(addFlavor(ogCopy));
...
console.log(removeLastFlavor(ogCopy));
...
console.log(getFlavorByIndex(ogCopy, 10));
...
function removeFlavorByName(arr, flavor){
   ...
   arr.splice(arr.indexOf(flavor), 6);
   return arr;
    
}
console.log(removeFlavorByName(ogCopy, "Chocolate"));
...
function filterByWord(arr, holidayFlav){

    for(let i = 0; i < arr.length; i++){
        if(arr[i].includes(holidayFlav)){
          console.log(arr[i]);
        }
      }
